...
const pageUrl = `${siteUrl}/maintenance-website-makassar`;
const socialImageUrl = getDefaultSocialImageUrl(siteUrl);

const pageTitle =
    'Maintenance Website Makassar Bulanan';
const pageDescription =
    'Jasa maintenance website Makassar untuk bisnis yang butuh website tetap aman, cepat, rapi, SEO-ready, dan mudah dikembangkan setiap bulan.';
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'Maintenance Website Makassar',
            },
        ],
        locale: 'id_ID',
        type: 'website',
...
const localProblems = [
    'Website bisnis Makassar sudah online, tapi jarang dicek',
    'Calon pelanggan dari Panakkukang, Pettarani, atau Tamalanrea klik WhatsApp, tapi tombol atau form tidak jalan',
    'Halaman lambat dibuka saat calon klien akses dari HP di jaringan mobile',
    'Mau tambah promo, paket, menu, jadwal, atau section baru tapi tidak punya developer',
    'Tidak tahu performa website setelah iklan lokal atau posting konten',
    'Website terlihat lama, tapi belum perlu redesign total',
];

const makassarFitItems = [
    'Rental mobil, travel, tour, dan transportasi lokal',
    'Klinik, dental care, salon, barbershop, dan beauty service',
    'Cafe, restoran, catering, dan bisnis kuliner Makassar',
    'Kursus, sekolah, kampus, komunitas, dan pelatihan',
    'Event organizer, venue, hotel, homestay, dan wisata lokal',
    'Kontraktor, interior, jasa profesional, toko, dan katalog produk',
];
...
const processSteps = [
    ...
    },
    {
        ...
        body: 'Masalah yang paling dekat dengan lead dan kepercayaan pelanggan dikerjakan dulu.',
    },
    {
...
const idealClients = [
    'Rental mobil dan travel area Makassar',
    'Klinik, dental care, salon, dan layanan profesional',
    'Cafe, restoran, catering, dan bisnis kuliner',
    'Kursus, sekolah, kampus, dan komunitas edukasi',
    'Event organizer, hotel, homestay, dan promotor acara',
    'Company profile bisnis Sulawesi Selatan yang sudah lama tidak diupdate',
];

const portfolioHighlights = [
    {
        title: 'Rental Mobil Makassar',
        note: 'Website promosi lokal dengan fokus trust dan lead WhatsApp.',
    ...
    },
    {
        ...
        note: 'Platform edukasi untuk akuisisi siswa dan penjualan kelas.',
...
const faqs = [
    {
        q: 'Apakah maintenance website Makassar ini bisa untuk website yang bukan dibuat BangunWebsite.id?',
        a: 'Bisa. Paket ini memang cocok untuk website lama yang sudah berjalan dan butuh dirawat, diperbaiki, atau dioptimalkan.',
    },
    {
        q: 'Apakah harus bertemu langsung di Makassar?',
        a: 'Tidak harus. Mayoritas proses bisa lewat WhatsApp. Kalau perlu meeting untuk bisnis Makassar dan sekitarnya, kita bisa atur sesuai kebutuhan.',
    },
    {
...
export default function MaintenanceWebsiteMakassarPage() {
    const { whatsappNumber, instagramUrl } = getPublicSiteConfig();
    const whatsappUrl = createWhatsappLink(
        whatsappNumber,
        'Halo BangunWebsite.id, saya ingin konsultasi maintenance website Makassar.'
    );
    ...
    const jsonLd = {
        ...
        priceRange: 'Rp500.000 - Rp2.000.000 per bulan',
        description: pageDescription,
        sameAs: [instagramUrl],
        makesOffer: {
            '@type': 'Offer',
            name: 'Maintenance Website Makassar',
            url: pageUrl,
        ...
        <main className='min-h-screen bg-slate-50 text-slate-950'>
            ...
            <section className='mx-auto grid w-full max-w-6xl gap-8 px-4 py-16 md:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:items-start'>
                <div>
                    ...
                    <h2 className='mt-3 text-2xl font-bold leading-tight sm:text-3xl md:text-4xl'>
                        Maintenance Website untuk Bisnis yang Bergerak di
                        Makassar dan Sekitarnya
                    </h2>
                    <p className='mt-4 text-base leading-7 text-slate-700 md:text-lg'>
                        Halaman ini dibuat khusus untuk bisnis lokal Makassar
                        yang mengandalkan pencarian Google, rekomendasi, iklan
                        lokal, dan chat WhatsApp dari calon pelanggan sekitar.
                    </p>
            ...
            <section className='border-b border-slate-200 bg-white py-16 md:py-20'>
                <div className='mx-auto w-full max-w-7xl px-4'>
                    <div className='mx-auto max-w-4xl text-center'>
                        ...
                        <h2 className='mt-3 text-2xl font-bold leading-tight sm:text-3xl md:text-4xl'>
                            Tinggal Chat via WhatsApp, Kami Proses Tambah Fitur
                            atau Update Kontennya
                        </h2>
                        <p className='mt-4 text-base leading-7 text-slate-700 md:text-lg'>
                            Request seperti tambah video, input konten dari
                            dokumen, atau tambah kategori bisa langsung dikirim
                            untuk dicek dan dieksekusi sesuai paket.
                        </p>
                    </div>

                    <div className='mx-auto mt-10 max-w-4xl rounded-[28px] border border-slate-200 bg-slate-950 p-4 shadow-[0_24px_70px_-45px_rgba(15,23,42,0.75)] sm:p-5'>
                        <div className='space-y-4'>
                            {maintenanceRequestScreenshots.map(
                                (image, index) => (
                                    <Image
                                        key={image.src}
                                        src={image.src}
            ...
            <section className='mx-auto w-full max-w-6xl px-4 py-16 md:py-20'>
                <div className='max-w-3xl'>
                    ...
                    <h2 className='mt-3 text-2xl font-bold leading-tight sm:text-3xl md:text-4xl'>
                        Banyak Website Bisnis Lokal Tidak Rusak Total, Tapi
                        Pelan-Pelan Kehilangan Peluang
                    </h2>
                    <p className='mt-4 text-base leading-7 text-slate-700 md:text-lg'>
                        Kalau website sudah ada tapi tidak rutin dicek, masalah
                        kecil bisa membuat calon pelanggan ragu sebelum sempat
                        menghubungi Anda.
                    </p>
                </div>
                ...
                <div className='mx-auto w-full max-w-6xl px-4'>
                    <div className='max-w-3xl'>
                        <p className='inline-flex rounded-full bg-slate-900 px-4 py-1 text-sm font-bold text-white'>
                            Paket maintenance website Makassar
                        </p>
                        <h2 className='mt-3 text-2xl font-bold leading-tight sm:text-3xl md:text-4xl'>
                        ...
                        <p className='mt-4 text-base leading-7 text-slate-700 md:text-lg'>
                            Pilih paket sesuai kondisi website dan ritme bisnis.
                            Fitur besar tetap dihitung sebagai project terpisah
                            agar scope bulanan tetap jelas.
                        </p>
                    </div>
                    ...
                    <div className='mt-8 rounded-[24px] border border-amber-200 bg-amber-50 p-5'>
                        <p className='text-sm leading-6 font-medium text-amber-900 md:text-base'>
                            Paket maintenance kami juga bisa dipakai untuk
                            tambah fitur. Cukup chat kebutuhan Anda via
                            WhatsApp, kami cek scope, susun prioritas, lalu
                            eksekusi sesuai jatah request paket bulanan.
                        </p>
                        <p className='mt-3 text-sm leading-6 font-medium text-amber-900 md:text-base'>
                            Request semi kompleks sampai kompleks dikerjakan
                            bertahap sesuai scope. Fitur besar seperti sistem
                            login penuh, payment gateway, aplikasi mobile,
                            dashboard kompleks, atau redesign total tetap
            ...
            <section className='mx-auto grid w-full max-w-6xl gap-10 px-4 py-16 md:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:items-start'>
                <div>
                    ...
                    <h2 className='mt-3 text-2xl font-bold leading-tight sm:text-3xl md:text-4xl'>
                        Untuk Bisnis Makassar yang Butuh Website Aktif, Bukan
                        Sekadar Online
                    </h2>
                    <p className='mt-4 text-base leading-7 text-slate-700 md:text-lg'>
            ...
            <section className='bg-slate-950 py-16 text-white md:py-20'>
                <div className='mx-auto w-full max-w-6xl px-4'>
                    <div className='max-w-3xl'>
                        ...
                        <h2 className='mt-3 text-2xl font-bold leading-tight sm:text-3xl md:text-4xl'>
                            Sudah Menangani Website Bisnis Lokal dan Sistem Web
                            di Sulawesi Selatan
                        </h2>
                    </div>
            ...
            <section id='faq' className='mx-auto w-full max-w-6xl px-4 py-16 md:py-20'>
                <h2 className='text-2xl font-bold leading-tight sm:text-3xl md:text-4xl'>
                    FAQ Maintenance Website Makassar
                </h2>
                ...
                <div className='mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 md:flex-row md:items-center md:justify-between'>
                    <div className='max-w-2xl'>
                        ...
                        <p className='mt-3 text-base leading-7 text-slate-200 md:text-lg'>
                            ...
                            bantu petakan apakah cukup maintenance bulanan atau
                            perlu project terpisah.
                        </p>
                    </div>
                    <a
                        href={whatsappUrl}
