                                                                ...
                                                                <td className='px-2 py-3'>
                                                                    <div className='flex justify-end gap-2'>
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className='rounded-lg border border-cyan-300 bg-cyan-50 px-2.5 py-1 text-xs font-bold text-cyan-700 transition hover:bg-cyan-100'
                                                                        >
                                                                            Edit
                                                                        </button>
                                                                        <button
                                                                            ...
                                                                            className='rounded-lg border border-red-200 bg-red-50 px-2.5 py-1 text-xs font-bold text-red-700 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-70'
                                                                        >
                                                                            {isDeletingBlogId ===
                                                                            post.id
                                                                                ? 'Hapus...'
